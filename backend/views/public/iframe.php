...
<head>
    <meta charset="utf-8">
    <title>layuiYM - 通用后台管理模板系统</title>
        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs" lay-unselect>
                    <a href="<?php echo Yii::$app->request->getHostInfo().'/yii2/frontend/web/index.php';?>" target="_blank" title="前台">
            ...
            <div class="layui-side-scroll">
                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="home" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['admin/index']); ?>">用户管理</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['role/index']); ?>">角色管理</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['permission/index']); ?>">权限管理</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['rule/index']); ?>">规则管理</a>
                            </dd>
                        </dl>
                    </li>
                    <li data-name="home" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['article/category']); ?>">分类管理</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['article/comment']); ?>">文章评论</a>
                            </dd>
                        </dl>
                    </li>
                    <li data-name="home" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['user/index']); ?>">用户管理</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo \yii\helpers\Url::to(['comment/index']); ?>">留言管理</a>
                            </dd>
                        </dl>
                    </li>
                    <li data-name="home" class="layui-nav-item">
